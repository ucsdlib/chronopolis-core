...
public class IngestRequest {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(IngestRequest.class);
    ...
    public String readStream(InputStream is, MessageDigest digest) throws IOException {
        ...
        // TODO: Restore this to how it used to be
        manifestFile = File.createTempFile("manifest", "tmp", Paths.get("/tmp").toFile());
    ...
    private boolean validateLine(String line) {
        ...
        if (digest.isEmpty()) {
            ...
            return false;
        } else if (! (m = pathRegex.matcher(path)).matches()) {
