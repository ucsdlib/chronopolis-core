...
public class IngestRequest {
    ...
    public String readStream(InputStream is, MessageDigest digest) throws IOException {
        ...
        manifestFile = File.createTempFile("manifest", "tmp", StrorageDirectoryListener.getManifestDirectory());
    ...
    private boolean validateLine(String line) {
        ...
        if (digest.isEmpty()) {
            ...
            return false;
        } else if (! (m = StrorageDirectoryListener.getPathRegex().matcher(path)).matches()) {
