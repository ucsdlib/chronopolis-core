...
import org.chronopolis.intake.duracloud.IngestRequest;
import org.chronopolis.intake.duracloud.StrorageDirectoryListener;
...
public class TicketManager {
    ...
    public boolean hasReturnManifest(String ticketId) {
        return new File(StrorageDirectoryListener.getManifestDirectory(), RESULT_PREFIX + ticketId).isFile();
    }
    ...
    private InputStream loadStream(String ticketId, String prefix) throws IOException {
        ...
        File ticketFile = new File(StrorageDirectoryListener.getManifestDirectory(), prefix + ticketId);
