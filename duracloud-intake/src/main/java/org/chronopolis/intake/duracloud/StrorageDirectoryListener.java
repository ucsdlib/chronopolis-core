 ...
 * @author toaster
 */
public class StrorageDirectoryListener implements ServletContextListener {
    ...
    private static final Logger LOG = Logger.getLogger(StrorageDirectoryListener.class);
