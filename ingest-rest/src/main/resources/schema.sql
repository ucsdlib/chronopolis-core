...
ALTER TABLE bag_storage
    ADD CONSTRAINT FK_bs_bag FOREIGN KEY (bag_id) REFERENCES bag ON DELETE CASCADE ;

ALTER TABLE token_storage
    ADD CONSTRAINT FK_ts_bag FOREIGN KEY (bag_id) REFERENCES bag ON DELETE CASCADE ;

ALTER TABLE bag_storage
    ADD CONSTRAINT FK_bs_storage FOREIGN KEY (staging_id) REFERENCES staging_storage ON DELETE CASCADE ;

ALTER TABLE token_storage
    ADD CONSTRAINT FK_ts_storage FOREIGN KEY (staging_id) REFERENCES staging_storage ON DELETE CASCADE ;
