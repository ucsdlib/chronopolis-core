CREATE INDEX idx_filename ON ace_token (bag, filename);
CREATE INDEX idx_bag_storage ON bag_storage (bag_id, staging_id);
CREATE INDEX idx_token_storage ON token_storage (bag_id, staging_id);
