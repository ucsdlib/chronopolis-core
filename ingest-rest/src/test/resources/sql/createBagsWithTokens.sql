...
INSERT INTO bag VALUES(1, CURRENT_DATE, CURRENT_DATE, 'new-bag-1', 'test-depositor', 'test-depositor/new-bag-1', 'test-depositor/new-bag-1-tokens', '', '', 'STAGED', 'SHA-256', 1500, 3, 3);
INSERT INTO bag VALUES(2, CURRENT_DATE, CURRENT_DATE, 'new-bag-2', 'test-depositor', 'test-depositor/new-bag-1', 'test-depositor/new-bag-2-tokens', NULL, NULL, 'STAGED', 'SHA-256', 1500, 3, 3);

-- create a third bag which has all tokens made
INSERT INTO bag VALUES(3, CURRENT_DATE, CURRENT_DATE, 'new-bag-3', 'test-depositor', 'test-depositor/new-bag-1', 'test-depositor/new-bag-3-tokens', '', '', 'STAGED', 'SHA-256', 1500, 3, 3);
