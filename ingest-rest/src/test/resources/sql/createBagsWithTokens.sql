...
INSERT INTO bag(id, created_at, updated_at, name, creator, depositor, status, required_replications) VALUES(1, CURRENT_DATE, CURRENT_DATE, 'new-bag-1', 'admin', 'test-depositor', 'STAGED', 3);
INSERT INTO bag(id, created_at, updated_at, name, creator, depositor, status, required_replications) VALUES(2, CURRENT_DATE, CURRENT_DATE, 'new-bag-2', 'admin', 'test-depositor', 'STAGED', 3);

-- create a third bag which has all tokens made
INSERT INTO bag(id, created_at, updated_at, name, creator, depositor, status, required_replications) VALUES(3, CURRENT_DATE, CURRENT_DATE, 'new-bag-3', 'admin', 'test-depositor', 'STAGED', 3);
...
INSERT INTO storage VALUES(1, 1, 1, 'test-depositor/new-bag-1', 1500, 3, CURRENT_DATE, CURRENT_DATE);
