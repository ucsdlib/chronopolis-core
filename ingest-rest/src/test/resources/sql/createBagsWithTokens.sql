...
INSERT INTO bag(id, created_at, updated_at, name, creator, depositor, status, size, total_files, required_replications) VALUES(DEFAULT, CURRENT_DATE, CURRENT_DATE, 'new-bag-1', 'admin', 'test-depositor', 'STAGED', 1, 1, 3);
INSERT INTO bag(id, created_at, updated_at, name, creator, depositor, status, size, total_files, required_replications) VALUES(DEFAULT, CURRENT_DATE, CURRENT_DATE, 'new-bag-2', 'admin', 'test-depositor', 'STAGED', 1, 1, 3);

-- create a third bag which has all tokens made
INSERT INTO bag(id, created_at, updated_at, name, creator, depositor, status, size, total_files, required_replications) VALUES(DEFAULT, CURRENT_DATE, CURRENT_DATE, 'new-bag-3', 'admin', 'test-depositor', 'STAGED', 1, 1, 3);
