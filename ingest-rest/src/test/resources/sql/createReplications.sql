...
INSERT INTO bag VALUES(1, CURRENT_DATE, CURRENT_DATE, 'bag-0', 'admin', 'test-depositor', 'bags/test-bag-0', 'tokens/test-bag-0', 'fixity', 'fixity', 'STAGED', 'SHA-256', 1500, 5, 3);
INSERT INTO bag VALUES(2, CURRENT_DATE, CURRENT_DATE, 'bag-1', 'admin', 'test-depositor', 'bags/test-bag-1', 'tokens/test-bag-1', 'fixity', 'fixity', 'STAGED', 'SHA-256', 1500, 5, 3);
